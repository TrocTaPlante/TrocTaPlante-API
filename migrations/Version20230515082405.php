 ...
 */
final class Version20230515082405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD longitude VARCHAR(255) NOT NULL, ADD latitude VARCHAR(255) NOT NULL, ADD post_status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP longitude, DROP latitude, DROP post_status');
    }
}
